 ...
 */
export const finalizeTestsStep = createStep({
    id: "finalizeTestsStep",
    inputSchema: z.object({
        containerId: z.string(),
        contextPath: z.string().optional(),
        testGeneration: TestGenerationResult,
